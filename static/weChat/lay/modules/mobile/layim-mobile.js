...
layui.define(['laytpl', 'upload-mobile', 'layer-mobile', 'zepto'], function(exports){
  ...
  var SHOW = 'layui-show', THIS = 'layim-this', MAX_ITEM = 40;
  ...
  LAYIM.prototype.on = function(events, callback){
    if(typeof callback === 'function'){
      // call[events] ? call[events].push(callback) : 
      call[events] = [callback];
    }
    return this;
  };
    ...
    ,'<div class="layim-chat-footer">'
      ...
      ,'<div class="layim-chat-tool" data-json="{{encodeURIComponent(JSON.stringify(d.data))}}">'
        ...
        ,'<span class="layui-icon layim-tool-image" title="发送文件" layim-event="image" data-type="file">&#xe61d;<input type="file" name="file"></span>'
         ,'{{# }; }}'
        //  ,'{{# if(d.base && d.base.sendphonetics){ }}'
        // ,'<span class="layui-icon layim-tool-image" title="语音" layim-event="linkToWechat" data-type="file"><a href="http://www.baidu.com">&#xe688;</a></span>'
        //  ,'{{# }; }}'
  ...
  var anim = 'layui-anim-upbit', events = { 
    ...
    ,about: function(){
      layer.open({
        content: '<p style="padding-bottom: 5px;">普信环保聊天</p><p>当前版本：layim mobile v'+ v + '</p><p>版权所有：<a href="http://layim.layui.com" target="_blank">layim.layui.com</a></p>'
